...
import type { EquipmentClassType, EquipmentOption as PkgEquipmentOption } from '@maple/game-data';

import type { AndroidEquipment } from './android-equipment';

/** 아이템 스탯 옵션 */
export type EquipmentOption = PkgEquipmentOption;
...
/** 잠재능력 & 에디셔널 잠재능력 정보 */
interface PotentialOptionShape {
  /** 잠재 */
