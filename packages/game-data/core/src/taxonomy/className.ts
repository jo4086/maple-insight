...
export type ClassName = keyof typeof classNameKeyMap;
export type ClassKey = (typeof classNameKeyMap)[ClassName];
export const classNames = Object.keys(classNameKeyMap) as ClassName[];
export const classNameKeys = Object.values(classNameKeyMap) as ClassKey[];
