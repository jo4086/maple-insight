import type { AllClassName, ClassGroup } from '../taxonomy';

export type Stat = 'STR' | 'DEX' | 'INT' | 'LUK' | 'HP';

export const specialStatClassNames = [
  '시프',
  '시프마스터',
  '섀도어',
  '세미듀어러',
...
export type SpecialStatClassMeta = {
  [K in SpecialStatClassName]: {
    mainStat: Stat[];
    subStat: Stat[];
  };
};

export const classGroupStatMetaMap = {
...
} as const satisfies ClassGroupStatMeta;

export const specialStatClassMetaMap = {
  제논: {
...
} as const satisfies SpecialStatClassMeta;
