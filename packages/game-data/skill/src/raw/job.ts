...
export const adventurerJobNameMap = {
  ...
  '532': '캐논마스터',
  '534': '캐논마스터',
} as const satisfies Record<string, AllClassName>;
...
function isClassNameArray(className: RawJobClassName): className is readonly AllClassName[] {
  return Array.isArray(className);
}

export function getAdventurerClassNameByJobId(jobId: string): AllClassName | undefined {
...
export function getClassNamesByJobId(jobId: string): readonly AllClassName[] {
