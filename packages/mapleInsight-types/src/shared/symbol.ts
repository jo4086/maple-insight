...
type NomalSymbolData = 'symbolStr' | 'symboldDex' | 'symbolInt' | 'symbolLuk' | 'symbolHp';
type GrandSymbolData = 'symbolExpRate' | 'symbolMesoRate' | 'symbolDropRate';
type SymbolShareData =
  | 'symbolName'
  | 'symbolIcon'
  | 'symbolDescription'
  | 'symbolForce'
