...
type CashItemRaw = NonNullable<NonNullable<AndroidRaw['android_cash_item_equipment']>[number]>;
...
function toCashItemOption(raw: NonNullable<CashItemRaw['cash_item_option']>[number]): CashItemOption {
  return {
...
function toAndroidInfo(raw: {
  ...
  android_cash_item_equipment?: CashItemRaw[] | null;
