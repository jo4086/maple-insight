...
function toPetEquipmentOption(raw: PetEquipmentRaw['item_option'][number]): PetEquipmentOption {
  return {
...
function toPetEquipment(raw: PetEquipmentRaw | null): PetEquipment | null {
  ...
  return {
    ...
    scrollUpgrade: raw.scroll_upgrade,
    scrollUpgradable: raw.scroll_upgradable,
