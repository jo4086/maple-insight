...
export const Character = () => {
  return (
    <Container className="p-6 bg-red-400">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* 전투력 */}
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-bold text-gray-800 mb-4">전투력</h3>
          <div className="text-3xl font-bold text-purple-600 mb-2">132,977,262</div>
          ...
          <div className="space-y-3 mt-6">
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-medium">칠흑의 보스 세트</div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-medium">에테르넬 세트</div>
            ...
            <div className="flex justify-between items-center">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-sm font-medium">아케인셰이드 세트</div>
                  <div className="text-xs text-gray-500">5</div>
                </div>
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        <div className="bg-white rounded-lg p-6 shadow-sm">
          <h3 className="text-lg font-bold text-gray-800 mb-4">빈칸</h3>
        ...
        <div className="bg-gray-800 rounded-lg p-6 text-white">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-lg font-bold">장비명 (+8)</h3>
          </div>

          <div className="text-sm text-blue-300 mb-4">(서브 데이터)</div>
